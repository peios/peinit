...
pub use audit::{
    ...
    encode_on_failure_loop_suppressed_event, encode_registry_reload_coalesced_event,
    encode_registry_reload_deferred_event, encode_reload_unconfirmed_event,
    encode_reload_undecodable_service_event, encode_safe_mode_downgrade_event,
    encode_service_access_denied_event, encode_service_internal_error_event,
    encode_shutdown_abandoned_event, encode_system_access_denied_event, kmes_event_subject,
    oversized_event_message,
};
pub use encode::{
